...
import com.emoor.glidee.load.MultiTransformation;
...
import com.emoor.glidee.load.resource.UnitTransformation;
...
import com.emoor.glidee.provider.ChildLoadProvider;
import com.emoor.glidee.provider.LoadProvider;
import com.emoor.glidee.request.FutureTarget;
import com.emoor.glidee.request.GenericRequest;
import com.emoor.glidee.request.Request;
import com.emoor.glidee.request.RequestCoordinator;
import com.emoor.glidee.request.RequestFutureTarget;
import com.emoor.glidee.request.RequestListener;
import com.emoor.glidee.request.ThumbnailRequestCoordinator;
import com.emoor.glidee.request.animation.GlideAnimationFactory;
import com.emoor.glidee.request.animation.NoAnimation;
import com.emoor.glidee.request.animation.ViewAnimationFactory;
import com.emoor.glidee.request.animation.ViewPropertyAnimation;
import com.emoor.glidee.request.animation.ViewPropertyAnimationFactory;
import com.emoor.glidee.request.target.PreloadTarget;
import com.emoor.glidee.request.target.Target;
import com.emoor.glidee.signature.EmptySignature;
 ...
 * @param <DataType> The data type that the resource {@link com.emoor.glidee.load.model.ModelLoader} will provide that
 *                  can be decoded by the {@link com.emoor.glidee.load.ResourceDecoder}.
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     *     {@link com.emoor.glidee.load.model.ModelLoader}, {@link com.emoor.glidee.load.ResourceDecoder}, and
    ...
    /**
     * Sets the {@link com.emoor.glidee.load.ResourceDecoder} to use to load the resource from the original data.
     * By default, this decoder will only be used if the final transformed resource is not in the disk cache.
     *
     * @see #cacheDecoder(com.emoor.glidee.load.ResourceDecoder)
     * @see com.emoor.glidee.load.engine.DiskCacheStrategy
     *
     * @param decoder The {@link com.emoor.glidee.load.ResourceDecoder} to use to decode the resource.
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link com.emoor.glidee.load.ResourceDecoder} to use to load the resource from the disk cache. By
     * default, this decoder will only be used if the final transformed resource is already in the disk cache.
     *
     * @see #decoder(com.emoor.glidee.load.ResourceDecoder)
     * @see com.emoor.glidee.load.engine.DiskCacheStrategy
     *
    ...
    /**
     * Sets the {@link com.emoor.glidee.load.engine.DiskCacheStrategy} to use for this load. Defaults to
     * {@link com.emoor.glidee.load.engine.DiskCacheStrategy#RESULT}.
     *
     * <p>
     *     For most applications {@link com.emoor.glidee.load.engine.DiskCacheStrategy#RESULT} is ideal.
     ...
     *     {@link com.emoor.glidee.load.engine.DiskCacheStrategy#SOURCE} or
     *     {@link com.emoor.glidee.load.engine.DiskCacheStrategy#RESULT}. Any download only operations should
     *     typically use {@link com.emoor.glidee.load.engine.DiskCacheStrategy#SOURCE}.
     * </p>
     *
    ...
    /**
     * Sets the {@link com.emoor.glidee.load.Encoder} to use to encode the original data directly to cache. Will only
     * be used if the original data is not already in cache and if the
     * {@link com.emoor.glidee.load.engine.DiskCacheStrategy} is set to
     * {@link com.emoor.glidee.load.engine.DiskCacheStrategy#SOURCE} or
     * {@link com.emoor.glidee.load.engine.DiskCacheStrategy#ALL}.
     *
     * @see #sourceEncoder(com.emoor.glidee.load.Encoder)
     * @see com.emoor.glidee.load.engine.DiskCacheStrategy
     *
    ...
    /**
     * Removes the current {@link com.emoor.glidee.load.Transformation}.
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link com.emoor.glidee.load.resource.transcode.ResourceTranscoder} to use for this load.
     *
     * @see com.emoor.glidee.load.resource.transcode.UnitTranscoder
     * @see com.emoor.glidee.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see com.emoor.glidee.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     *
     * @see #animate(int)
     * @see #animate(com.emoor.glidee.request.animation.ViewPropertyAnimation.Animator)
     *
     ...
     * {@link #animate(com.emoor.glidee.request.animation.ViewPropertyAnimation.Animator)}. Scheduled to be removed in
     * Glide 4.0.
     ...
     * memory cache).
     *
     * @param animator The {@link com.emoor.glidee.request.animation.ViewPropertyAnimation.Animator} to run.
     * @return This request builder.
     */
     ...
     * impractical to return that size from {@link Target#getSize(com.emoor.glidee.request.target.SizeReadyCallback)}.
     *
     ...
     * </p>
     *
     * @see com.emoor.glidee.signature.StringSignature
     *
     * @param signature A unique non-null {@link com.emoor.glidee.load.Key} representing the current state of the
     ...
     *
     * <p>
     *      This method must be called at least once before {@link #into(com.emoor.glidee.request.target.Target)} is
     *      called.
     * </p>
     *
     ...
     *
     * @see Glide#clear(com.emoor.glidee.request.target.Target)
     *
     ...
     * @return The {@link com.emoor.glidee.request.target.Target} used to wrap the given {@link ImageView}.
     */
     ...
     *              {@link #override * (int, int)}} if previously called).
     *
     * @see Glide#clear(com.emoor.glidee.request.FutureTarget)
     *
     * @return An {@link com.emoor.glidee.request.FutureTarget} that can be used to obtain the
     ...
     *
     *
     * @see com.emoor.glidee.ListPreloader
     *
     * @param width The desired width in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     *             {@link #override * (int, int)} if previously called.
     * @param height The desired height in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     ...
     *        {@link Glide#clear(com.emoor.glidee.request.target.Target)}.
     */
