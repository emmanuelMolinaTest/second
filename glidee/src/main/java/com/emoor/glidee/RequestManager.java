...
import com.emoor.glidee.load.model.file_descriptor.FileDescriptorModelLoader;
import com.emoor.glidee.load.model.stream.MediaStoreStreamLoader;
import com.emoor.glidee.load.model.stream.StreamByteArrayLoader;
import com.emoor.glidee.load.model.stream.StreamModelLoader;
import com.emoor.glidee.manager.ConnectivityMonitor;
import com.emoor.glidee.manager.ConnectivityMonitorFactory;
import com.emoor.glidee.manager.Lifecycle;
import com.emoor.glidee.manager.LifecycleListener;
import com.emoor.glidee.manager.RequestManagerTreeNode;
import com.emoor.glidee.manager.RequestTracker;
import com.emoor.glidee.signature.ApplicationVersionSignature;
import com.emoor.glidee.signature.MediaStoreSignature;
import com.emoor.glidee.signature.StringSignature;
...
public class RequestManager implements LifecycleListener {
     ...
     * {@link com.emoor.glidee.RequestManager}.
     */
     ...
     *
     * <p>
     *     Note - These options will be retained for the life the of this {@link com.emoor.glidee.RequestManager}
     *     so be wary of using
     *     {@link com.emoor.glidee.GenericRequestBuilder#listener(com.emoor.glidee.request.RequestListener)}} when
    ...
    /**
     * Returns a request builder that uses the given {@link com.emoor.glidee.load.model.ModelLoader} to fetch a
     * generic data type.
     *
     * <p>
    ...
    /**
     * Returns a request builder that uses the given {@link com.emoor.glidee.load.model.stream.StreamModelLoader} to
     ...
     * {@link com.emoor.glidee.load.model.stream.StreamByteArrayLoader} to fetch an {@link java.io.InputStream} for
     * loading Bitmaps.
     *
     ...
     * @see #load(Object)
     *
     * @param string A file path, or a uri or url handled by {@link com.emoor.glidee.load.model.UriLoader}.
     */
     ...
     *     {@link com.emoor.glidee.GenericRequestBuilder#signature(com.emoor.glidee.load.Key)} to mixin a signature
     *     you create that identifies the data currently at the given String that will invalidate the cache if that data
     *     changes. Alternatively, using {@link com.emoor.glidee.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.emoor.glidee.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     * @see #load(String)
     ...
     * {@link com.emoor.glidee.load.model.UriLoader}.
     */
     ...
     *     Alternatively, using {@link com.emoor.glidee.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.emoor.glidee.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     ...
     * @see com.emoor.glidee.GenericRequestBuilder#signature(com.emoor.glidee.load.Key)
     */
     ...
     * @see com.emoor.glidee.GenericRequestBuilder#signature(com.emoor.glidee.load.Key)
     * @see com.emoor.glidee.signature.MediaStoreSignature
     *
     * @deprecated Use {@link #loadFromMediaStore(android.net.Uri)},
     * {@link com.emoor.glidee.signature.MediaStoreSignature}, and
     * {@link com.emoor.glidee.DrawableRequestBuilder#signature(com.emoor.glidee.load.Key)} instead. Scheduled to be
     ...
     *
     * <p>
     *  Falls back to the registered {@link com.emoor.glidee.load.model.ModelLoaderFactory} registered for
     ...
     *     {@link com.emoor.glidee.GenericRequestBuilder#signature(com.emoor.glidee.load.Key)} to mix in some
     *     additional data identifying the current state of the Uri, preferably using
     *     {@link com.emoor.glidee.signature.MediaStoreSignature}. Alternatively consider avoiding the memory and
     *     disk caches entirely using
     *     {@link GenericRequestBuilder#diskCacheStrategy(com.emoor.glidee.load.engine.DiskCacheStrategy)}
     *     and {@link com.emoor.glidee.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.emoor.glidee.GenericRequestBuilder#skipMemoryCache(boolean)}.
     * </p>
     *
     * @see #from(Class)
     * @see #loadFromMediaStore(android.net.Uri, String, long, int)
    ...
    /**
     * Returns a request builder that uses the {@link com.emoor.glidee.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@link com.emoor.glidee.load.model.stream.StreamFileLoader.Factory} and
     * {@link com.emoor.glidee.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     *
     *  <p>
     ...
     * to {@link com.emoor.glidee.load.model.stream.StreamResourceLoader.Factory} and
     * {@link com.emoor.glidee.load.model.stream.StreamResourceLoader} to load resource id models.
     *
     * <p>
     ...
     *     cached data. To get around this, consider using {@link com.emoor.glidee.load.engine.DiskCacheStrategy#NONE}
     *     via {@link GenericRequestBuilder#diskCacheStrategy(com.emoor.glidee.load.engine.DiskCacheStrategy)}
     *     during development, and re-enabling the default
     *     {@link com.emoor.glidee.load.engine.DiskCacheStrategy#RESULT} for release builds.
     * </p>
     *
     * @see #from(Class)
     * @see #load(Integer)
     * @see com.emoor.glidee.signature.ApplicationVersionSignature
     * @see com.emoor.glidee.GenericRequestBuilder#signature(com.emoor.glidee.load.Key)
     */
     ...
     * {@link com.emoor.glidee.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@link com.emoor.glidee.load.data.HttpUrlFetcher} to load {@link java.net.URL} models.
     *
     * @see #from(Class)
     ...
     * {@link com.emoor.glidee.GenericRequestBuilder#signature(com.emoor.glidee.load.Key)} instead. Scheduled to be
     * removed in Glide 4.0.
    ...
    /**
     * Returns a request builder that uses {@link com.emoor.glidee.load.model.stream.StreamByteArrayLoader} to load
    ...
    /**
     * Returns a request builder that uses the {@link com.emoor.glidee.load.model.ModelLoaderFactory}s currently
     ...
     * {@link com.emoor.glidee.load.model.ModelLoaderFactory}s registered for the given model class for
     ...
     *
     * <p>
     *     Note - you must use {@link com.emoor.glidee.DrawableRequestBuilder#load(Object)}} to set a concrete model
     *     to be loaded before calling
     *     {@link com.emoor.glidee.DrawableRequestBuilder#into(com.emoor.glidee.request.target.Target)}. You may
     *     also use this object for repeated loads by calling <code>request.load(model).into(target)</code>. You may
     *     also adjust the options after calling {@link com.emoor.glidee.DrawableRequestBuilder#load(Object)}} and/or
     *     {@link com.emoor.glidee.DrawableRequestBuilder#into(com.emoor.glidee.request.target.Target)}}. However,
    ...
    public final class ImageModelRequest<T> {
        ...
        /**
         * Returns a request builder that uses the provided {@link com.emoor.glidee.load.model.ModelLoader} to load
     ...
     * @param <T> The type of data the {@link com.emoor.glidee.load.model.ModelLoader} provides an
     * {@link com.emoor.glidee.load.data.DataFetcher} to convert the model to.
     */
    public final class GenericModelRequest<A, T> {
        ...
        /**
         * A helper class for building requests with custom {@link com.emoor.glidee.load.model.ModelLoader}s that
