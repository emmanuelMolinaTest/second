package com.emoor.glidee.load;

/**
 * Options for setting the value of {@link android.graphics.Bitmap#getConfig()} for {@link android.graphics.Bitmap}s
 * returned by a {@link com.emoor.glidee.load.resource.bitmap.BitmapDecoder}.
 *
 * <p>
 *     Note - In some cases it may not be possible to obey the requested setting, not all
 *     {@link com.emoor.glidee.load.resource.bitmap.BitmapDecoder}s support setting formats and certain images may
...
public enum DecodeFormat {
    /**
     * All bitmaps returned by the {@link com.emoor.glidee.load.resource.bitmap.BitmapDecoder} should return
