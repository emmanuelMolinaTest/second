 ...
 * {@link Context}.
 *
 * @param <T> The type of the model the {@link com.emoor.glidee.load.model.ModelLoader}s built by this factory
 *           can handle
 * @param <Y> The type of data the {@link com.emoor.glidee.load.model.ModelLoader}s built by this factory can load.
 */
