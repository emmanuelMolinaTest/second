...
/**
 * An {@link com.emoor.glidee.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * {@link com.emoor.glidee.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s and then uses an LRU
