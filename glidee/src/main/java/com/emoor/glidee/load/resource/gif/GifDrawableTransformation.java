...
/**
 * An {@link com.emoor.glidee.load.Transformation} that wraps a transformation for a {@link Bitmap}
 * and can apply it to every frame of any {@link com.emoor.glidee.load.resource.gif.GifDrawable}.
 */
