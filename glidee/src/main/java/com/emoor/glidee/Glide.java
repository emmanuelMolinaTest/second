...
import com.emoor.glidee.load.engine.Engine;
import com.emoor.glidee.load.engine.bitmap_recycle.BitmapPool;
import com.emoor.glidee.load.engine.cache.DiskLruCacheFactory;
import com.emoor.glidee.load.engine.cache.MemoryCache;
import com.emoor.glidee.load.engine.prefill.BitmapPreFiller;
import com.emoor.glidee.load.engine.prefill.PreFillType;
...
import com.emoor.glidee.load.model.file_descriptor.FileDescriptorFileLoader;
import com.emoor.glidee.load.model.file_descriptor.FileDescriptorResourceLoader;
import com.emoor.glidee.load.model.file_descriptor.FileDescriptorStringLoader;
import com.emoor.glidee.load.model.file_descriptor.FileDescriptorUriLoader;
import com.emoor.glidee.load.model.stream.HttpUrlGlideUrlLoader;
import com.emoor.glidee.load.model.stream.StreamByteArrayLoader;
import com.emoor.glidee.load.model.stream.StreamFileLoader;
import com.emoor.glidee.load.model.stream.StreamResourceLoader;
import com.emoor.glidee.load.model.stream.StreamStringLoader;
import com.emoor.glidee.load.model.stream.StreamUriLoader;
import com.emoor.glidee.load.model.stream.StreamUrlLoader;
import com.emoor.glidee.load.resource.bitmap.CenterCrop;
import com.emoor.glidee.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import com.emoor.glidee.load.resource.bitmap.FitCenter;
import com.emoor.glidee.load.resource.bitmap.GlideBitmapDrawable;
import com.emoor.glidee.load.resource.bitmap.ImageVideoDataLoadProvider;
import com.emoor.glidee.load.resource.bitmap.StreamBitmapDataLoadProvider;
import com.emoor.glidee.load.resource.drawable.GlideDrawable;
import com.emoor.glidee.load.resource.file.StreamFileDataLoadProvider;
import com.emoor.glidee.load.resource.gif.GifDrawable;
import com.emoor.glidee.load.resource.gif.GifDrawableLoadProvider;
import com.emoor.glidee.load.resource.gifbitmap.GifBitmapWrapper;
import com.emoor.glidee.load.resource.gifbitmap.GifBitmapWrapperTransformation;
import com.emoor.glidee.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import com.emoor.glidee.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import com.emoor.glidee.load.resource.transcode.GlideBitmapDrawableTranscoder;
import com.emoor.glidee.load.resource.transcode.ResourceTranscoder;
import com.emoor.glidee.load.resource.transcode.TranscoderRegistry;
import com.emoor.glidee.manager.RequestManagerRetriever;
import com.emoor.glidee.module.GlideModule;
import com.emoor.glidee.module.ManifestParser;
import com.emoor.glidee.provider.DataLoadProvider;
import com.emoor.glidee.provider.DataLoadProviderRegistry;
...
import com.emoor.glidee.request.target.ImageViewTargetFactory;
import com.emoor.glidee.request.target.Target;
import com.emoor.glidee.request.target.ViewTarget;
 ...
 * maintaining an {@link Engine}, {@link BitmapPool}, {@link com.emoor.glidee.load.engine.cache.DiskCache} and
 * {@link MemoryCache}.
 */
public class Glide {
     ...
     *
     * @deprecated Use {@link com.emoor.glidee.module.GlideModule} instead. Scheduled to be removed in Glide 4.0.
     */
    @Deprecated
    ...
    /**
     * Returns the {@link com.emoor.glidee.load.engine.bitmap_recycle.BitmapPool} used to temporarily store
     ...
     *     {@link com.emoor.glidee.load.ResourceDecoder}s and {@link com.emoor.glidee.load.Transformation}s. Use
    ...
    /**
     * Pre-fills the {@link com.emoor.glidee.load.engine.bitmap_recycle.BitmapPool} using the given sizes.
     *
     * <p>
     ...
     *     re-filling the {@link com.emoor.glidee.load.engine.bitmap_recycle.BitmapPool}. Rotation should be carefully
     ...
     *     {@link com.emoor.glidee.load.engine.prefill.PreFillType.Builder Builders} representing
     ...
     * models. Typically the {@link RequestManager#using(com.emoor.glidee.load.model.stream.StreamModelLoader)} or
     * {@link RequestManager#using(com.emoor.glidee.load.model.file_descriptor.FileDescriptorModelLoader)} syntax is
     ...
     * </p>
     *
     * @see RequestManager#using(com.emoor.glidee.load.model.file_descriptor.FileDescriptorModelLoader)
     * @see RequestManager#using(com.emoor.glidee.load.model.stream.StreamModelLoader)
     *
     ...
     *
     * @deprecated Use {@link #register(Class, Class, com.emoor.glidee.load.model.ModelLoaderFactory)} to replace
