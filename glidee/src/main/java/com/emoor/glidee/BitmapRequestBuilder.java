...
import com.emoor.glidee.load.resource.bitmap.BitmapTransformation;
import com.emoor.glidee.load.resource.bitmap.Downsampler;
import com.emoor.glidee.load.resource.bitmap.FileDescriptorBitmapDecoder;
import com.emoor.glidee.load.resource.bitmap.ImageVideoBitmapDecoder;
import com.emoor.glidee.load.resource.bitmap.StreamBitmapDecoder;
import com.emoor.glidee.load.resource.bitmap.VideoBitmapDecoder;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
     ...
     * {@link com.emoor.glidee.load.resource.bitmap.Downsampler#AT_MOST}.
     *
     * @see #downsample(com.emoor.glidee.load.resource.bitmap.Downsampler)
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link com.emoor.glidee.load.ResourceDecoder} that will be used to decode {@link Bitmap}s obtained
     ...
     * {@link #cacheDecoder(com.emoor.glidee.load.ResourceDecoder)}} with default decoders with the appropriate
     * options set.
     *
     * <p>
    ...
    /**
     * Transform images using the given {@link com.emoor.glidee.load.resource.bitmap.BitmapTransformation}s.
     *
     * @see #centerCrop()
     * @see #fitCenter()
     * @see #transform(com.emoor.glidee.load.Transformation[])
     *
    ...
    /**
     * Transform images using {@link com.emoor.glidee.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transform(com.emoor.glidee.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(com.emoor.glidee.load.Transformation[])
     *
     * @return This request builder.
     */
    ...
    /**
     * Transform images using {@link com.emoor.glidee.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(com.emoor.glidee.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(com.emoor.glidee.load.Transformation[])
