...
/**
 * A {@link com.emoor.glidee.request.animation.GlideAnimationFactory} that produces
 * {@link com.emoor.glidee.request.animation.ViewAnimation}s.
 *
...
public class ViewAnimationFactory<R> implements GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link com.emoor.glidee.request.animation.GlideAnimation} for the given arguments. If
     * isFromMemoryCache is {@code true} or isFirstImage is {@code false}, returns a
     * {@link com.emoor.glidee.request.animation.NoAnimation} and otherwise returns a new
