...
/**
 * A factory class that can produce different {@link com.emoor.glidee.request.animation.GlideAnimation}s based on the
...
public interface GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link com.emoor.glidee.request.animation.GlideAnimation}.
     *
