 ...
 * {@link com.emoor.glidee.request.target.Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * ({@link com.emoor.glidee.request.animation.ViewAnimation},
     * {@link com.emoor.glidee.request.animation.ViewPropertyAnimation} and animated
     ...
     * @param adapter The {@link com.emoor.glidee.request.animation.GlideAnimation.ViewAdapter} wrapping a view that
     *                can at least return an {@link android.view.View} from
     *                {@link com.emoor.glidee.request.animation.GlideAnimation.ViewAdapter#getView()}.
