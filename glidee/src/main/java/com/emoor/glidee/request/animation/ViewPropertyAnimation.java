...
/**
 * A {@link com.emoor.glidee.request.animation.GlideAnimation GlideAnimation} that accepts an interface
...
public class ViewPropertyAnimation<R> implements GlideAnimation<R> {
     ...
     * {@link com.emoor.glidee.request.animation.ViewPropertyAnimation.Animator} interface that can apply an animation
     * to a view.
     *
    ...
    /**
     * Always applies the {@link com.emoor.glidee.request.animation.ViewPropertyAnimation.Animator} given in the
