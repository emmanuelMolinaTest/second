...
import com.emoor.glidee.load.resource.transcode.GifDrawableBytesTranscoder;
import com.emoor.glidee.load.resource.transcode.ResourceTranscoder;
import com.emoor.glidee.provider.DataLoadProvider;
import com.emoor.glidee.provider.FixedLoadProvider;

import java.io.InputStream;

/**
 * A class for creating a load request that either loads an {@link com.emoor.glidee.load.resource.gif.GifDrawable}
 * directly or that adds an {@link com.emoor.glidee.load.resource.transcode.ResourceTranscoder} to transcode
 * {@link com.emoor.glidee.load.resource.gif.GifDrawable} into another resource type.
 *
 * @param <ModelType> The type of model to load the {@link com.emoor.glidee.load.resource.gif.GifDrawable} or other
...
public class GifTypeRequest<ModelType> extends GifRequestBuilder<ModelType> {
    ...
    /**
     * Sets a transcoder to transcode the decoded {@link com.emoor.glidee.load.resource.gif.GifDrawable} into another
     * resource type.
     *
     * @param transcoder The transcoder to use.
     * @param transcodeClass The {@link Class} of the resource the
     * {@link com.emoor.glidee.load.resource.gif.GifDrawable} will be transcoded to.
     *
     * @param <R> The type of the resource the {@link com.emoor.glidee.load.resource.gif.GifDrawable} will be
     *           trasncoded to.
