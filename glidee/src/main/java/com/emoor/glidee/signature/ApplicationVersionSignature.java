...
/**
 * A utility class for obtaining a {@link com.emoor.glidee.load.Key} signature containing the application version
...
public final class ApplicationVersionSignature {
    ...
    /**
     * Returns the signature {@link com.emoor.glidee.load.Key} for version code of the Application of the given
     * Context.
     */
