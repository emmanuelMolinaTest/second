...
/**
 * A view-less {@link android.app.Fragment} used to safely store an {@link com.emoor.glidee.RequestManager} that
 * can be used to start, stop and manage Glide requests started for targets the fragment or activity this fragment is a
 * child of.
 *
 * @see com.emoor.glidee.manager.SupportRequestManagerFragment
 * @see com.emoor.glidee.manager.RequestManagerRetriever
 * @see com.emoor.glidee.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
    ...
    /**
     * Sets the current {@link com.emoor.glidee.RequestManager}.
     *
    ...
    /**
     * Returns the current {@link com.emoor.glidee.RequestManager} or null if none exists.
     */
