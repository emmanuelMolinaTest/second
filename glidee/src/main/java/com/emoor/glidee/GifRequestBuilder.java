...
public class GifRequestBuilder<ModelType>
    ...
    /**
     * Transforms each frame of the GIF using {@link com.emoor.glidee.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transformFrame(com.emoor.glidee.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(com.emoor.glidee.load.Transformation[])
    ...
    /**
     * Transforms each frame of the GIF using {@link com.emoor.glidee.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transformFrame(com.emoor.glidee.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(com.emoor.glidee.load.Transformation[])
